...
void start_running(const char* filename)
{
    ...
    strategys.emplace_back(std::make_shared<dual_thrust_trading_strategy>(1, run, "ag2512", 3, 0.2, 0.2, 1, true, "/root/tb_furture_data/AG9999.XSGE.csv", "2013-01-04", 3, "14:59"));
