...
void start_running(const char* filename)
{
    ...
    strategys.emplace_back(std::make_shared<dual_thrust_trading_strategy>(1, run, "ag2512", 5, 0.5, 0.5, 1, true, "/root/tb_furture_data/AG9999.XSGE.csv", "20130101", 5, "14:59"));
